...
void setHomeDir(char *path) { homeDir = path; }
...
processDetails *getChildProcessList() { return childProcessList; }
...
char **getHistoryList() { return historyList; }

int getHistoryLength() { return historyLength; }

void setHistoryLength(int len) { historyLength = len; }


char *oldDir = NULL;

void setOldDir(char *dir) { oldDir = dir; }

char *getOldDir() { return oldDir; }

/* ***************************** */

int currentFgPid = -1;

void setCurrentFgPid(int fgPid) { currentFgPid = fgPid; }

int getCurrentFgPid() { return currentFgPid; }
